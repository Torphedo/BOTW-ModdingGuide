...
-Before I go over the final steps in BCML setup, it's a good time to cover some common misconceptions about BCML. BCML isn't doing the actual loading of mod files, Cemu handles that. BCML merges the mod files of multiple mods, then sends them to Cemu to load. This means that you can close BCML as long as it's not remerging or changing your mod list in any way. In order to merge multiple mods, it uses the game files you got from your console and edits them as dictated by a mod. **This does NOT edit your original game files, you can uninstall mods whenever you want.**
